      ...
      <div class="row">
        <div class="col-md-7" style="padding-left: 180px;">
          ...
          <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;">Welcome Administrator!</h4>
          </div>
        </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
                <h3 style="margin-top: 5%">Admin Login</h3><br>
                <form class="form-group" method="POST" action="newfunc.php">
                  <div class="row" style="margin-top: 10%">
                    <div class="col-md-4"><label>Username: </label></div>
                    <div class="col-md-8"><input type="text" name="username1" class="form-control" placeholder="Enter Username" required/></div><br><br>
                  ...
                  <div class="row">
                    <div class="col-md-12" style="margin-top: 10%">
                      <center><input type="submit" id="inputbtn" name="adsub" value="Login" class="btn btn-primary btn-block"></center>
                    </div>
                  </div>
                </form>
              </center>
