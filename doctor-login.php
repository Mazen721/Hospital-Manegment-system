      ...
      <div class="row">
        <div class="col-md-7" style="padding-left: 180px;">
          ...
          <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;">Welcome Doctor!</h4>
          </div>
        </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
                <h3 style="margin-top: 5%">Doctor Login</h3><br>
                <form class="form-group" method="POST" action="func1.php">
                  <div class="row" style="margin-top: 10%">
                    <div class="col-md-4"><label>Username: </label></div>
                    <div class="col-md-8"><input type="text" name="username3" class="form-control" placeholder="Enter Username" required/></div><br><br>
                    <div class="col-md-4" style="margin-top: 8%"><label>Password: </label></div>
                    <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password3" placeholder="Enter Password" required/></div><br><br><br>
                  </div>
                  <div class="row">
                    <div class="col-md-12" style="margin-top: 10%">
                      <center><input type="submit" id="inputbtn" name="docsub1" value="Login" class="btn btn-primary btn-block"></center>
                    </div>
                  </div>
                </form>
              </center>
