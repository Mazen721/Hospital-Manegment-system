              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-12" style="margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-primary btn-block"></center></div>           
                </div>
              </form>
              <div class="row" style="margin-top: 20px;">
                <div class="col-md-12">
                  <center><a href="index.php" style="color: #0062cc; font-weight: 600; text-decoration: none;">Don't have an account? <span style="text-decoration: underline;">Register here</span></a></center>
                </div>
              </div>
            </center>
            </div>
